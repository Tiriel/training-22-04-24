 ...
 */
final class Version20240426140540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:simple_array)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:simple_array)
        , preferred_channel VARCHAR(50) DEFAULT NULL, birthday DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, password, roles, preferred_channel, birthday) SELECT id, email, password, roles, preferred_channel, birthday FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}
